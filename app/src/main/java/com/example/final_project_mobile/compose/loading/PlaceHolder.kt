package com.example.final_project_mobile.compose.loading
...
object PlaceholderDefaults {
    ...
    val shimmerAnimationSpec: InfiniteRepeatableSpec<Float> by lazy {
        infiniteRepeatable(
            animation = tween(delayMillis = 200, durationMillis = 1700),
...
fun Modifier.placeholder(
    ...
    var highlightProgress: Float by remember { mutableFloatStateOf(0.0f) }
    ...
    val placeholderAlpha by transition.animateFloat(
        ...
        targetValueByState = { placeholderVisible -> if (placeholderVisible) 1.0f else 0.0f },
    )
    val contentAlpha by transition.animateFloat(
        transitionSpec = contentFadeTransitionSpec,
        label = "content_fade",
        targetValueByState = { placeholderVisible -> if (placeholderVisible) 0.0f else 1.0f },
    )
